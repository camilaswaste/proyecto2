    ...
    <DashboardLayout role="Socio">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Gestiona tus entrenamientos personalizados</p>
        </div>
            ...
            <Card>
              <CardContent className="py-8">
                ...
                <div className="text-center mt-4">
                  <Button onClick={() => (window.location.href = "/socio/entrenadores")}>Agendar Sesión</Button>
                </div>
              </CardContent>
            </Card>
          ) : (
                ...
                <Card key={sesion.SesionID} className="opacity-75">
                  <CardContent className="py-4">
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        <p className="font-medium">{sesion.NombreEntrenador}</p>
